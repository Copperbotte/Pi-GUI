...
#             resetButton.place(relx=3 / 4 - .025, rely=.025, relwidth=1 / 4, relheight=1 / 3)
        ...
        def refresh_label(self):
            self.nodeState.config(text=str('0'))#can_receive.node_dict_list[self.name]["state"]))
...
class VentAbortFrame:
    ...
    def __init__(self, parent):
        ...
        ventAbortFrame.place(relx=0.14, rely=0.85, relwidth=0.85, relheight=0.15)
...
class PropulsionFrame:
    ...
    def __init__(self, parent):
        ...
        self.propFrame.place(relx=0.11, rely=0.2, relwidth=0.9, relheight=0.65)
        ...
        self.Button = Button(self.parent, fg='red', bg='black', bd=5)
