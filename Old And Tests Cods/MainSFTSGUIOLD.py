...
class NodeFrame:
    ...
    def __init__(self, parent):
        ...
        padGroundFrame = self.Node(nodeFrame)
        padGroundFrame.labelarray = ["Pad Ground Node", "Activity: ", "MCU Temp: ", "Bus Info"]
        padGroundFrame.makeNodeLabels()
    ...
    class Node:
        ...
        def makeNodeLabels(self):
            ...
            for i in range(numberOfLabels):
                ...
                nodeLabels[i].place(relx=0.01, rely=(1 / numberOfLabels) * i+.01, relwidth=1/2, relheight=1/(numberOfLabels+1))
...
class StateButtons:
    ...
    def MainStateInstantiation(self):
        ...
        button = Button(self.parent, text=self.args[0],fg='red', bg='black', bd = 5, command=lambda: self.Logic(), font = self.fontSize)
    ...
    def VentAbortInstantiation(self):
        ...
        button = Button(self.parent, text=self.args[0], command=lambda: self.StateActuaction(),fg='red', bg='grey', font=self.fontSize)
    ...
    def StateActuaction(self):
        if self.state:
            button = Button(self.parent, text=self.args[0],fg='red', bg=self.bgcolor, bd = 5, command=lambda: self.Logic(), font = self.fontSize)
            self.state = False
##            msg = can.Message(arbitration_id=self.commandID, data=[self.commandON], is_extended_id=False)  # ////
##            bus.send(msg)  # //////////////////////////////////////////////////////////////////////////////////////
##            #    
        else:
            button = Button(self.parent, text=self.args[0],fg='green', bg=self.bgcolor, bd = 5, command=lambda: self.Logic(), font = self.fontSize)
            self.state = True
##            msg = can.Message(arbitration_id=self.commandID, data=[self.commandON], is_extended_id=False)  # ////
##            bus.send(msg)  # //////////////////////////////////////////////////////////////////////////////////////
##            #    
...
class VentAbortFrame:
    ...
    def __init__(self, parent):
        ...
        img = Label(ventAbortFrame, image=render, bg='Black')
        img.image = render
...
class PropulsionFrame:
    ...
    def __init__(self, parent):
        ...
        engineart = Image.open("GUI Images/Engine Clipart.png")
        ...
        self.propFrame.create_line(25, 100, 25, 1000, fill="white", width=5)
        self.propFrame.create_line(25, 600, 100, 600, fill="white", width=5)
        self.propFrame.create_line(25, 325, 225, 325, fill="white", width=5)
        self.propFrame.create_line(225, 82, 225, 525, fill="white", width=5)
        self.propFrame.create_line(225, 82, 325, 82, fill="white", width=5)
        self.propFrame.create_line(225, 525, 325, 525, fill="white", width=5)
        self.propFrame.create_line(325, 60, 325, 150, fill="white", width=5)
        self.propFrame.create_line(325, 400, 325, 600, fill="white", width=5)
        self.propFrame.create_line(325, 150, 665, 150, fill="white", width=5)
        self.propFrame.create_line(665, 150, 665, 350, fill="white", width=5)
        self.propFrame.create_line(665, 350, 850, 350, fill="white", width=5)
        self.propFrame.create_line(850, 350, 850, 50, fill="white", width=5)
        self.propFrame.create_line(850, 50, 1115, 50, fill="white", width=5)
        self.propFrame.create_line(1115, 50, 1115, 120, fill="white", width=5)
        self.propFrame.create_line(1115, 120, 1035, 120, fill="white", width=5)
        self.propFrame.create_line(1035, 120, 1035, 300, fill="white", width=5)
        self.propFrame.create_line(325, 400, 665, 400, fill="white", width=5)
        self.propFrame.create_line(665, 400, 665, 600, fill="white", width=5)
        self.propFrame.create_line(665, 600, 900, 600, fill="white", width=5)
        self.propFrame.create_line(900, 600, 900, 120, fill="white", width=5)
        self.propFrame.create_line(900, 120, 1000, 120, fill="white", width=5)
        self.propFrame.create_line(1000, 120, 1000, 300, fill="white", width=5)
...
class TimeFrame:
    def refresh_label(self):
        time_label = Label(self.time_frame,fg="Orange", bg='grey', text=datetime.datetime.now().strftime("%d/%m/%Y %H:%M:%S"), font=("Verdana", 17))
...
app.attributes("-fullscreen",True)  # "zoomed" is fullscreen except taskbars on startup, "fullscreen" is no taskbars true fullscreen
